...
<script src="<?= base_url() ?>assets/plugins/jquery-jeditable/jquery.jeditable.min.js"></script>
<script src="<?= base_url() ?>assets/plugins/jquery.maskedinput/jquery.maskedinput.js"></script>
<script src="<?= base_url() ?>assets/plugins/jquery-jeditable/jquery.jeditable.masked.min.js"></script>
<script src="<?= base_url() ?>assets/plugins/jquery-ui/jquery-ui.min.js"></script> <!-- required by datepicker plugin -->
<script src="<?= base_url() ?>assets/plugins/jquery-jeditable/jquery.jeditable.datepicker.min.js"></script>
<script src="<?= base_url() ?>assets/plugins/justgage/raphael.min.js"></script>
<script src="<?= base_url() ?>assets/plugins/justgage/justgage.min.js"></script>
...
<script src="<?= base_url() ?>assets/plugins/bootstrap-tour/bootstrap-tour-standalone.js"></script>
